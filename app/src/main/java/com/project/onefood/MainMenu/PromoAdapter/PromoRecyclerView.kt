...
class PromoRecyclerView(private val context : Context, private var list: ArrayList<promoItem>) : RecyclerView.Adapter<PromoRecyclerView.MyViewHolder>() {
    ...
    private val imgsArr = arrayOf("https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=AeJbb3cqX_fJsKwwmu5IMksj9O5G-KoyuMDhQ15_rXHA39l2jAKxyHmUjmO-7ie1ropzCKTiijXUnO0SVcRzUKiypz-HrXvPOo6Zh8R5_Ghed0mcIeXHnZAwwgamaG-FLCCReNBVJ4J1qjfn-7wRfqdFdKxyNRQZbRfviaqFzKQB6tFKWc2Q&key=",
        "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=AeJbb3dEMbe3VuNJ-BQDRuJabbDjPY1lEmkdT0Qgy8S7CgjEdSplR0kakrb1EVAckuv4AARkxBlsILF2iXGulmQR7tgcDdMKGRYcbfvaD14XYRmIWSEDzkDz_Wq1lmhn3QQE5dyjkTY2SvrPB7_Z3ryGy4ywJIiYFFa5A1cHZiVE3fEyjJhc&key=",
        "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=AeJbb3fFR6Mgu1O_V5Hbt5Pqa9OEiCBSj8NKjnhSeUjPFM8nTnubXKxoUE7ujDBB3QX-RMJEJeZs7p6HPNWUbzafVuaVV58rdEQK7TuubZC_6e5XHgLTrzVRLBr66BI9B_g61utCeHLfQw8xpdMwZvvMYZTOyQj830Sa80NUN1zOChT9r5KP&key=",
        "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=AeJbb3fqC3JFCePYVFrx3gCPPrc9mr7jEHGhQ6HKPf3jlodA3BO_mIDoJ-Ywt2ZUXE5K06r_vudn7YrK0g9JUeIVYtVfGYhRiHhgx_QGGoIjLYsJ2I0sl6XD1xOtASqpnMuu3fQDFdfmHtRrLoSZNwdw84Lv4jf9l9UlVYKYTIECN0_e9jIL&key=")
